...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { phone_number: @office.phone_number, physician_id: @office.physician_id, street: @office.street, zip_code: @office.zip_code } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { phone_number: @office.phone_number, physician_id: @office.physician_id, street: @office.street, zip_code: @office.zip_code } }
